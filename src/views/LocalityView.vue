<template>
  <div>
    ...
    <!-- Suspense is used to load the AsyncLocalityView component. Suspense is experimental feature for Vue 3. -->
    <Suspense>
      <AsyncLocalityView />
      <template #fallback>
        <div class="pt-48 flex items-top justify-center min-h-screen">
          <svg
            aria-hidden="true"
            class="w-28 h-28 text-gray-200 animate-spin dark:text-gray-600 fill-meteo-secondary"
            viewBox="0 0 100 101"
            fill="none"
